...
namespace WinProcessExtensions
{
    public class ProcessRunner : IProcessRunner
    {
        ...
        public int LaunchProcessWithoutShellExecuteAndWaitExitCode(string fileName, string arguments, Action<string> logOutput, Action<string> logError)
        {
        ...
        public int LaunchProcessWithoutShellExecuteAndWaitExitCode(string fileName, string arguments, Action<string> logOutput, Action<string> logError, int timeoutMilliseconds)
        {
            var process = CreateProcessInfoToRunWithoutShellExecute(fileName, arguments, true, true, logOutput: logOutput, logError: logError);
            var started = process.Start();
            if (!started) throw new Exception("Couldn't start process");
        ...
        public int LaunchProcessWithoutShellExecuteAndWaitExitCode(string fileName, string arguments, bool getStdOutput, bool getStdError, Action<string> logOutput, Action<string> logError)
        {
        ...
        private Process CreateProcessInfoToRunWithoutShellExecute(string fileName, string arguments, bool getStdOutput, bool getStdError, Action<string> logOutput, Action<string> logError)
        {
